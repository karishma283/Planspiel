        ...
        return (
            <div id="recentnews" >
                ...
                <List className="my-list">
                    <Item style={{ width: '90%', float: 'left', marginLeft: "5%", marginBottom: "3%", padding: 0 }} align="top" multipleLine >

                        <div style={{ width: '100%', float: 'left', paddingLeft: 10 }} >
                            <span style={{ fontSize: 12, fontWeight: 'bold', width: '100%' }} >2020 Chempionship: Barcelona - Real Madrid </span>
                            {/* <Speech
                                styles={style}
                                text="I have changed the colour of the play buttons and made them smaller"
                            /> */}
                            <Brief style={{ fontSize: 10 }}>Just now - {'2020 Chempionship'} {popover} - 3 mins 20 sec</Brief>
                        </div>
                    </Item>
                    ...
                    {Object.values(news).map((val, key) => {
                        return <Item style={{ width: '90%', float: 'left', marginLeft: "5%", marginBottom: "3%", padding: 0 }} key={key} align="top" multipleLine >
                            ...
                            <div style={{ width: '100%', float: 'left', paddingLeft: 10 }} >
                                <span style={{ fontSize: 12, fontWeight: 'bold', width: '100%' }} onClick={() => this.handleArticle(val._id)}>2020 Chempionship: Barcelona - Real Madrid </span>
